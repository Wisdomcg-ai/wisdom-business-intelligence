...
Commit message: `docs(roadmap): mark 44-07 complete; populate 44.1 plan list`.
  </action>
  <verify>
  ...
  <acceptance_criteria>
    ...
    - `.planning/ROADMAP.md` Phase 44.1 entry contains all 7 plan checkboxes (44.1-01 through 44.1-07).
