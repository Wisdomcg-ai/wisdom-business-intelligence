        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-brand-orange focus:border-brand-orange-500"
              disabled={loading}
            >
          ...
          <button
            ...
            className="px-4 py-2 bg-brand-orange text-white rounded-lg hover:bg-brand-orange-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
          >
          ...
          {message && (
            <div className={`p-3 rounded-lg ${
              ...
              'bg-brand-orange-50 text-brand-orange-800 border border-brand-orange-200'
            }`}>
              {message}
            </div>
          )}
