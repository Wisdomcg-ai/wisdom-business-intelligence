              ...
              return (
                <div
                  ...
                  className={`rounded-xl border p-4 transition-all ${
                    status === 'carried' ? 'bg-slate-50 border-slate-200' :
                    status === 'removed' ? 'bg-slate-50 border-slate-200 opacity-60' :
                    status === 'deferred' ? 'bg-slate-50 border-slate-200' :
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        {status !== 'unchanged' && (
                          <span className={`text-xs px-2 py-0.5 rounded ${
                            status === 'carried' ? 'bg-slate-200 text-slate-800' :
                            status === 'removed' ? 'bg-slate-200 text-slate-800' :
          ...
          <div className="bg-white rounded-lg p-4 mb-4 border border-gray-200">
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-2 bg-teal-600 text-white rounded-lg font-medium hover:bg-teal-700 disabled:bg-gray-200 disabled:cursor-not-allowed"
              >
                Add Initiative
              </button>
            </div>
