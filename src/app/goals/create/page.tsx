        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div className="text-base sm:text-lg font-semibold">Annual Goal</div>
              ...
              >
                <div className="text-base sm:text-lg font-semibold">90-Day Rock</div>
          ...
          {/* Timeline & Ownership */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Timeline & Ownership</h2>
          ...
          {/* Measurement */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Measurement</h2>
          ...
          {/* Notes */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Additional Notes</h2>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between gap-3 sm:gap-0">
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-brand-orange text-white px-8 py-2 rounded-lg hover:bg-brand-orange-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
