        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-4">
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  disabled={saving}
                  className="flex items-center gap-2 px-6 py-2 bg-brand-orange text-white hover:bg-brand-orange-600 rounded-lg shadow-sm transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed font-medium"
                >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Email Address</h2>
            </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 sm:p-6">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
                ...
                <span className="font-mono text-xs break-all sm:break-normal">{user?.id}</span>
              </div>
              <div className="flex justify-between">
                <span>Email Verified:</span>
                <span className={user?.email_confirmed_at ? 'text-green-600' : 'text-brand-orange-600'}>
