      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              {steps.map((step) => (
                <div
                  ...
                  className={`flex-1 text-center text-xs ${
                    step.number <= currentStep ? 'text-white' : 'text-purple-200'
                  }`}
                >
                  Step {step.number}
                </div>
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            <CurrentStepIcon className="w-16 h-16 text-purple-600 mx-auto mb-4" />
          ...
          <div className="mb-6">
            ...
            {currentStep === 5 && (
              <div className="bg-purple-50 rounded-lg p-4">
                <p className="text-purple-900 font-medium mb-3">Your Commitment:</p>
