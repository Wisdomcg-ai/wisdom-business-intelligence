-- Migration: Add Custom KPIs Library
-- Description: Allows users to create custom KPIs that can be shared across the platform
-- Author: System
-- Date: 2025-01-15

-- Create custom_kpis_library table
CREATE TABLE IF NOT EXISTS custom_kpis_library (
